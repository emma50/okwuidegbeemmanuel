      ...
      <nav className={`bg-white border-gray-200 backdrop-blur-sm ${toggleMode ? 'bg-white/30' : 'dark:bg-black/30'}`}>
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-6 px-12">
          <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill={`${!toggleMode ? 'text-black' : 'text-white'}`} viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className={`w-6 h-6 ${!toggleMode ? 'text-white' : 'text-black'}`} onClick={() => setToggleMode(!toggleMode)}>
